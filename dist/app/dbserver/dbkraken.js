...
function syncOrderBook() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.KRAKEN)); _i < _a.length; _i++) {
        var pr = _a[_i];
        var _loop_1 = function (symbol) {
            // book
            db_1.feed.getOrderBook(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol, level: 10 }).then(function (book) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
...
function syncBestBidBestAsk() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.KRAKEN)); _i < _a.length; _i++) {
        ...
        var _loop_2 = function (symbol) {
            // best bid best ask
            db_1.feed.getBestBidBestAsk(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol }).then(function (best_bid_best_ask) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
...
function syncTicker() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.KRAKEN)); _i < _a.length; _i++) {
        ...
        var _loop_3 = function (symbol) {
            // ticker 
            db_1.feed.getTicker(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol }).then(function (tick) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
...
function syncTrades() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.KRAKEN)); _i < _a.length; _i++) {
        ...
        var _loop_4 = function (symbol) {
            // Trades 
            db_1.feed.getAllTrades(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol }).then(function (trades) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
...
function syncOHLC() {
    ...
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.KRAKEN)); _i < _a.length; _i++) {
        ...
        var _loop_5 = function (symbol) {
            //historical - 15 days
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol, timeScale: 21600 }).then(function (past_rates) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
            ...
            //historical - 7 days
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol, timeScale: 10080 }).then(function (past_rates) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
            ...
            //historical - 1 Day
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.KRAKEN, { productID: symbol, timeScale: 1440 }).then(function (past_rates) {
                var query = {
                    exchange: 'kraken',
                    product_id: symbol
                };
...
//# sourceMappingURL=dbkraken.js.map