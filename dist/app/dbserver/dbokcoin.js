...
function syncOrderBook() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.OKCOIN)); _i < _a.length; _i++) {
        var pr = _a[_i];
        var _loop_1 = function (symbol) {
            // book
            db_1.feed.getOrderBook(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol, level: 10 }).then(function (book) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
...
function syncTicker() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.OKCOIN)); _i < _a.length; _i++) {
        ...
        var _loop_3 = function (symbol) {
            // ticker 
            db_1.feed.getTicker(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol }).then(function (tick) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
...
function syncTrades() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.OKCOIN)); _i < _a.length; _i++) {
        ...
        var _loop_4 = function (symbol) {
            // Trades 
            db_1.feed.getAllTrades(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol }).then(function (trades) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
...
function syncOHLC() {
    ...
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.OKCOIN)); _i < _a.length; _i++) {
        ...
        var _loop_5 = function (symbol) {
            ...
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol, startTime: sTScale_day.toISOString(), timeScale: '1day', limit: 1000 }).then(function (past_rates) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
                ...
                db_1.HistoricalData.findOne(query, function (err, doc) {
                    // console.log("doc ", JSON.stringify(doc))
                });
            });
            //historical - timescale - 1H
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol, startTime: sTScale_hour.toISOString(), timeScale: '1hour', limit: 1000 }).then(function (past_rates) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
            ...
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.OKCOIN, { productID: symbol, startTime: sTScale_minute.toISOString(), timeScale: '1min', level: 1000 }).then(function (past_rates) {
                var query = {
                    exchange: 'okcoin',
                    product_id: symbol
                };
...
//# sourceMappingURL=dbokcoin.js.map