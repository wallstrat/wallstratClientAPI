...
function syncOrderBook() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.BITREX)); _i < _a.length; _i++) {
        var pr = _a[_i];
        var _loop_1 = function (symbol) {
            // book
            db_1.feed.getOrderBook(wallstrat_1.ExchangeCodes.BITREX, { productID: symbol, side: 'both' }).then(function (book) {
                var query = {
                    exchange: 'bitrex',
                    product_id: symbol
                };
...
function syncBestBidBestAsk() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.BITREX)); _i < _a.length; _i++) {
        ...
        var _loop_2 = function (symbol) {
            // best bid best ask
            db_1.feed.getBestBidBestAsk(wallstrat_1.ExchangeCodes.BITREX, { productID: symbol }).then(function (best_bid_best_ask) {
                var query = {
                    exchange: 'bitrex',
                    product_id: symbol
                };
...
function syncTicker() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.BITREX)); _i < _a.length; _i++) {
        ...
        var _loop_3 = function (symbol) {
            // ticker 
            db_1.feed.getTicker(wallstrat_1.ExchangeCodes.BITREX, { productID: symbol }).then(function (tick) {
                var query = {
                    exchange: 'bitrex',
                    product_id: symbol
                };
...
function syncTrades() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.BITREX)); _i < _a.length; _i++) {
        ...
        var _loop_4 = function (symbol) {
            // Trades 
            db_1.feed.getAllTrades(wallstrat_1.ExchangeCodes.BITREX, { productID: symbol }).then(function (trades) {
                var query = {
                    exchange: 'bitrex',
                    product_id: symbol
                };
...
function syncOHLC() {
    for (var _i = 0, _a = (db_1.feed.getProductsPairs(wallstrat_1.ExchangeCodes.BITREX)); _i < _a.length; _i++) {
        ...
        var _loop_5 = function (symbol) {
            db_1.feed.getHistoricRates(wallstrat_1.ExchangeCodes.BITREX, { productID: symbol }).then(function (past_rates) {
                var query = {
                    exchange: 'bitrex',
                    product_id: symbol
                };
...
//# sourceMappingURL=dbbitrex.js.map